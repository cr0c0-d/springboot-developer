...
public class BlogApiController {
    ...
    public ResponseEntity<Article> updateArticle(@PathVariable long id, @RequestBody @Validated UpdateArticleRequest request) {
